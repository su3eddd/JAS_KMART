...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style-frozen.css">
...
<body>
    ...
    <!-- PRODUCTS -->
    <div class="head">
        <img src="assets/images/page banner/meats.jpg">
    </div>
    <section class="container">
        <div class="products-container">

            <?php
      $select_product = mysqli_query($conn, "SELECT * FROM `meat`");
    ...
    <!-- footer end -->
        ...
        <script src="assets/js/script-frozen.js"></script>
</body>
