   ...
   switch ($select) {
      ...
      if ($upload) {
         ...
         echo "<script> 
                ...
                window.open('display_dishes.php','_self');
              </script>";
      } else {
...
if (isset($_GET['delete'])) {
   ...
   header('location: display_dishes.php');
};
...
<body>
   ...
   ?>
    ...
    <?php
      $select = mysqli_query($conn, "SELECT * FROM dishes");
    ...
    <div class="product-display">
        <table class="product-display-table">
            ...
            <tr>
                ...
                <td>
                    <a href="update products/updish.php?edit=<?php echo $row['id']; ?>" class="btn"> <i
                            class="fas fa-edit"></i> edit </a>
                    <a href="display_dishes.php?delete=<?php echo $row['id']; ?>" class="btn"> <i
