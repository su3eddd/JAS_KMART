   ...
   switch ($select) {
      ...
      if ($upload) {
         ...
         echo "<script> 
                ...
                window.open('display_newarrival.php','_self');
              </script>";
      } else {
...
if (isset($_GET['delete'])) {
   $id = $_GET['delete'];
   mysqli_query($conn, "DELETE FROM newarrival WHERE id = $id");
...
<body>
   ...
   ?>
    ...
    <?php
      $select = mysqli_query($conn, "SELECT * FROM newarrival");
    ...
    <div class="product-display">
        <table class="product-display-table">
            ...
            <tr>
                ...
                <td>
                    <a href="update products/uparr.php?edit=<?php echo $row['id']; ?>" class="btn"> <i
                            class="fas fa-edit"></i> edit </a>
                    <a href="display_newarrival.php?delete=<?php echo $row['id']; ?>" class="btn"> <i
