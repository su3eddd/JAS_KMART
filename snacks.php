...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style-snack.css">
...
<body>
    ...
    <!-- PRODUCTS -->
    <div class="head">
        <img src="assets/images/page banner/snacks.jpg">
    </div>
    ...
    <section class="container">
        <div class="products-container">
            ...
            <?php
      $select_product = mysqli_query($conn, "SELECT * FROM `snacks`");
    ...
    <script src="assets/js/script-snack.js"></script>
</body>
