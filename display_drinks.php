   ...
   switch ($select) {
      ...
      if ($upload) {
         ...
         echo "<script> 
                ...
                window.open('display_drinks.php','_self');
              </script>";
      } else {
...
if (isset($_GET['delete'])) {
   ...
   header('location: display_drinks.php');
};
...
<body>
   ...
   ?>
    ...
    <?php
      $select = mysqli_query($conn, "SELECT * FROM drinks");
    ...
    <div class="product-display">
        <table class="product-display-table">
            ...
            <tr>
                ...
                <td>
                    <a href="update products/updrink.php?edit=<?php echo $row['id']; ?>" class="btn"> <i
                            class="fas fa-edit"></i> edit </a>
                    <a href="display_drinks.php?delete=<?php echo $row['id']; ?>" class="btn"> <i
