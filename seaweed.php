...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style-seaw.css">
...
<body>
    ...
    <!-- PRODUCTS -->
    <div class="head">
        <img src="assets/images/page banner/dishes.jpg">
    </div>
    ...
    <section class="container">
        <div class="products-container">
            ...
            <?php
      $select_product = mysqli_query($conn, "SELECT * FROM `dishes`");
    ...
    <script src="assets/js/script-seaw.js"></script>
</body>
