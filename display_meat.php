   ...
   switch ($select) {
      ...
      if ($upload) {
         ...
         echo "<script> 
                ...
                window.open('display_meat.php','_self');
              </script>";
      } else {
...
if (isset($_GET['delete'])) {
   $id = $_GET['delete'];
   mysqli_query($conn, "DELETE FROM meat WHERE id = $id");
   header('location: display_meat.php');
};
...
<body>
   ...
   ?>
    ...
    <?php
      $select = mysqli_query($conn, "SELECT * FROM meat");
    ...
    <div class="product-display">
        <table class="product-display-table">
            ...
            <tr>
                ...
                <td>
                    <a href="update products/upmeat.php?edit=<?php echo $row['id']; ?>" class="btn"> <i
                            class="fas fa-edit"></i> edit </a>
                    <a href="display_meat.php?delete=<?php echo $row['id']; ?>" class="btn"> <i
