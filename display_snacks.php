   ...
   switch ($select) {
      ...
      if ($upload) {
         ...
         echo "<script> 
                ...
                window.open('display_snacks.php','_self');
              </script>";
      } else {
...
if (isset($_GET['delete'])) {
   $id = $_GET['delete'];
   mysqli_query($conn, "DELETE FROM snacks WHERE id = $id");
   header('location: display_snacks.php');
};
...
<body>
   ...
   ?>
    ...
    <?php
      $select = mysqli_query($conn, "SELECT * FROM snacks");
    ...
    <div class="product-display">
        <table class="product-display-table">
            ...
            <tr>
                ...
                <td>
                    <a href="update products/upsnack.php?edit=<?php echo $row['id']; ?>" class="btn"> <i
                            class="fas fa-edit"></i> edit </a>
                    <a href="display_snacks.php?delete=<?php echo $row['id']; ?>" class="btn"> <i
