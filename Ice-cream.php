...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style-cream.css">
...
<body>
    ...
    <!-- PRODUCTS -->
    <div class="head">
        <img src="assets/images/page banner/ice cream.jpg">
    </div>
    <section class="container">
        <div class="products-container">

            <?php
      $select_product = mysqli_query($conn, "SELECT * FROM `ice_cream`");
    ...
    <script src="assets/js/script-cream.js"></script>
</body>
