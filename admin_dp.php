         ...
         <table class="product-display-table">
            ...
            <?php while ($row = mysqli_fetch_assoc($select)) { ?>
               <tr>
                  ...
                  <td>
                     <a href="update products/updateproduct.php?edit=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
                     <a href="admin_dp.php?delete=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
                  </td>
               </tr>
            <?php } ?>  
         </table>
