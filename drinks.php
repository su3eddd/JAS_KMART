...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style-drink.css">
...
<body>
    ...
    <!-- PRODUCTS -->
    <div class="head">
        <img src="assets/images/page banner/drinks.jpg">
    </div>
    <section class="container">
        <div class="products-container">

            <?php
      $select_product = mysqli_query($conn, "SELECT * FROM `drinks`");
    ...
    <script src="assets/js/script-drink.js"></script>
</body>
